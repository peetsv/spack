...
class Patch(object):
    ...
    @staticmethod
    def create(pkg, path_or_url, level, working_dir, **kwargs):
        """
        ...
        Args:
            ...
            level: patch level
            working_dir: dir to change to before applying the patch
        ...
        if '://' in path_or_url:
            return UrlPatch(pkg, path_or_url, level, working_dir, **kwargs)
...
class FilePatch(Patch):
    ...
    def __init__(self, pkg, path_or_url, level, working_dir):
        super(FilePatch, self).__init__(pkg, path_or_url, level, working_dir)
...
class UrlPatch(Patch):
    ...
    def __init__(self, pkg, path_or_url, level, working_dir, **kwargs):
        super(UrlPatch, self).__init__(pkg, path_or_url, level, working_dir)
